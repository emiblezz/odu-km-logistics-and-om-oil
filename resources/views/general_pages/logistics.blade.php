    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h2 data-aos="fade-up">Your Logistics Partner</h2>
          <p data-aos="fade-up" data-aos-delay="100">For any Logistics and Transportation , Procurement and Sourcing of all kinds of goods from Asia , Europe , America, and all African countries. Assistance in Forwarding , clearance and consultation services .</p>
          ...
          <div class="row gy-4" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="col-lg-3 col-6">
              <div class="stats-item text-center w-100 h-100">
                ...
                <p>Projects / contracts complited</p>
              </div>
            </div><!-- End Stats Item -->
            ...
            <div class="accordion accordion-flush" id="faqlist">
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
                    ...
                    How fast can you Transport?
                  </button>
                </h3>
                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    we can transport your goods as fast as we can since we have very many trucks and fuel tankers and experienced drivers
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item">
                ...
                <div id="faq-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    we are 24/7 available at our ccustomers disposable
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item">
                ...
                <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    <i class="bi bi-question-circle question-icon"></i>
                    we advertise all our jobs, when you qualify we will be glad to have you in our company.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-5">
                    <i class="bi bi-question-circle question-icon"></i>
                    where can i talk about business to you?
                  </button>
                </h3>
                <div id="faq-content-5" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    please contact us at <a href="">contact</a> and we will be glad to do business with you
                  </div>
                </div>
              </div><!-- # Faq item-->
